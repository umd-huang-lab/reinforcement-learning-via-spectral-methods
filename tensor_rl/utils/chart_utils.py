...
def average_data(data, cumulative=False):
    ...
    for i, all_instances in enumerate(data):
        ...
        try:
            ...
            raise ValueError("(tensor_rl) Plotting Error: an algorithm was run with inconsistent parameters (likely inconsistent number of Episodes/Instances. Try clearing old data).")
...
#    pyplot.legend(bbox_to_anchor=(1.05, 1), loc=2, borderaxespad=0.)
    ...
    for i, agent_name in enumerate(agents):
        ...
        if add_legend:
            pyplot.legend()
#            pyplot.legend(bbox_to_anchor=(1.15, 1), loc=2, borderaxespad=0., fontsize='small')
#            pyplot.legend(bbox_to_anchor=(0., -.5, 1., .2), loc=2, ncol=3, 
